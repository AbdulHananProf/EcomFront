                        ...
                        <div className="container-fluid">
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <TextField  type="text" id="outlined-basic" onChange={handleChange}  label="Category Name" name="CategoryName" variant="outlined" />
                                </div>
                                <div className="col-md-4">
                                    <TextField type="text" id="outlined-basic" onChange={handleChange} label="Category Slug" required name="CategorySlug" variant="outlined" />
                                </div>
                                <div className="col-md-4">
