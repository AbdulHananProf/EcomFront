...
import { CategoryAdd, url, SizeAdd } from "../../controllers/WebController";
    ...
    const addItem = () => {
      ...
      const saveData = async (e) => {
        ...
        if (Name && Shirtsizes.length !==0 ) {
            ...
            const res = await SizeAdd(formData)
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <TextField type="text" id="outlined-basic" onChange={handleChange} onBlur={createSlug} label="Name" name="Name" variant="outlined" placeholder="Shirt ,Trouser, Shalwar " />
                                </div>
